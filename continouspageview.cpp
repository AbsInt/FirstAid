...
void
ContinousPageView::gotoPage(int page)
{
...
void
ContinousPageView::resizeEvent(QResizeEvent */*resizeEvent*/)
{
...
void
ContinousPageView::keyPressEvent(QKeyEvent *event)
{
...
void
ContinousPageView::slotGotoRequested(const QString &destination)
{
...
void
ContinousPageView::slotCopyRequested(const QRectF &rect)
{
    if (rect.isNull())
        return;
...
void
ContinousPageView::slotFindStarted()
{
    paint();
}
...
void
ContinousPageView::slotHighlightMatch(int page, const QRectF &)
{
    gotoPage(page);
}
...
void
ContinousPageView::slotMatchesFound(int page, const QList<QRectF> &)
{
